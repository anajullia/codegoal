            ...
            <div class="grid-container-cart">
                ...
                if (isset($_COOKIE['carrinho'])) {
                    foreach ($carrinho as $id_produto => $quantidade) {
                        ...
                        $code_produto_carrinho = "SELECT * FROM camisas WHERE id_produto = " . $id_produto;
                        ...
                        echo "
                            <div class='card-container-cart'>
                                ...
                                <div class='conteudo-card-cart'>
                                    <img src='../imgs/" . $produto_carrinho[$num_carrinho]['imagem_camisa'] . "' alt=''>

                                    <div class='txt-card-cart'>

                                        <div class='title-card-cart'>" . $produto_carrinho[$num_carrinho]['nome_camisa'] . "</div>

                                        <div class='prices-card-cart'>
                                            <div class='incash-card-cart'>R$" . str_replace('.', ',', $produto_carrinho[$num_carrinho]['preco_camisa']) ."</div>
                                        </div>
